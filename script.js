...
const BASE_URL = "https://hitarthi31.github.io/TaylorSwiftAlbum/";
...
function updateUI() {
  ...
  console.log("audioSource.src", audioSource.src);
  console.log("BASE_URL", BASE_URL + albumAudio);

  if (audioSource.src != BASE_URL + albumAudio) {
...
function changeSong(direction) {
  ...
  console.log("Inside changeSong function");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  gsap
    .timeline({ delay: 0.5 }) // Delay for page load
    .to(splashScreen, {
      opacity: 1,
      visibility: "visible",
      duration: 1,
